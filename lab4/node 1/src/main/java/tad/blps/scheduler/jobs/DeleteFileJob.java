...
public class DeleteFileJob implements Job {
    private FileToDelService fileService;
    ...
    @Autowired
    public void setFileService( FileToDelService fileService) {
    ...
    public void execute(JobExecutionContext jec) throws JobExecutionException {
        List<Long> fileDelId = this.fileService.getListNeedDel();
        ...
        System.out.println("Sending list to second node...");
        
        sender.sendMessage(fileDelId);
    }
